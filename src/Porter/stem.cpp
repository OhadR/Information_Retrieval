...
I hope its working ! , compile it as c file
if u integrate it with cpp file
...
#define numberStopWords 319
char * stopWordsLocal[numberStopWords]= {"a", "about", "above",
	...
	char *string;
{
    ...
    for(i=0; i< numberStopWords ; i++)
      if (strcmp(string,stopWordsLocal[i])==0)
        string[0]=NULL;
